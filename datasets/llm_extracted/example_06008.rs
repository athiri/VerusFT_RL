    ...
    decreases val
{
    if val == 0 {
        ...
        /* code modified by LLM (iteration 2): fixed type issues and replaced fold with recursive approach */
...
{
    /* code modified by LLM (iteration 2): fixed int literal suffix errors */
    let mut coeff = vec![1];
