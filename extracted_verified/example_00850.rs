                ...
                forall|p: int, q: int| 0 <= p < i <= q < n ==> a[p] <= a[q],
        {
            ...
            while j < n
                invariant
                    ...
                    i <= min_idx < n,
                    i < j <= n,
                    /* code modified by LLM (iteration 1): Fixed type mismatch by casting indices to int for specification */
                    ...
                    forall|p: int, q: int| 0 <= p < i <= q < n ==> a[p] <= a[q],
            {
                /* code modified by LLM (iteration 1): Fixed type mismatch by casting indices to int for array access */
