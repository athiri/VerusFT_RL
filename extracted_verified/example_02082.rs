...
This means I need to return (min_index, second_min_index) where the first is the index of the minimum element and the second is the index of the second smallest element.
