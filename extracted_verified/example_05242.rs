...
fn main() {
    /* code modified by LLM (iteration 3): Fixed integer literals to use proper int values and simplified printing */
    ...
    // Print each element by converting to i32 for display
    let mut i = 0;
    print!("Result: [");
    while i < result.len() {
        if i > 0 {
