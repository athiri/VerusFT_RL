    ...
    )
{
    ...
    /* code modified by LLM (iteration 1): Fixed type annotation for lengths vector */
    ...
    {
        /* code modified by LLM (iteration 1): Replaced slice operations with direct vector access */
