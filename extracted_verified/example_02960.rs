    ...
    // post-conditions-end
{
            ...
            s@.to_multiset() == ret@.to_multiset(),
    {
        ...
        if min_idx != i {
            /* code modified by LLM (iteration 1): Store old sequence value before swap and use correct old() syntax */
            let old_ret_seq = ret@;
            let temp = ret[i];
            ...
            proof {
                swap_preserves_multiset(old_ret_seq, ret@, i as int, min_idx as int);
            }
        }
        i += 1;
    }
