...
{
    // The proof follows from the ensures clauses of max_array
    // Since max_array returns max_array_aux_spec(a, 1nat, a[0])
    // and its ensures clauses guarantee the postcondition properties
}
